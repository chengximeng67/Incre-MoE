...
def convert_csv_to_coco(csv_file, json_file):
    coco_output = {
        ...
        "annotations": [],
        "categories": [
            {"id": 1, "name": "vehicle", "supercategory": "other"}
        ]
    }
...
if __name__ == "__main__":
    get_annotation_eval(
        csv_file="/home/enbo/chxm/MBMoE/dataset/vehicle_dataset/test.csv", 
        start_index=1,
        end_index=5000, 
    ...
    checkpoint_path = "/home/enbo/chxm/MBMoE/vector_pruning/base_weight.pth"
    device = "cuda"
    num_select = 300
    anno_path = "/home/enbo/chxm/Grounding-Dino-FineTuning/data_process/eval_csv/temp.json"
    image_dir = "/home/enbo/chxm/MBMoE/dataset/vehicle_dataset/test"
    num_workers = 4
