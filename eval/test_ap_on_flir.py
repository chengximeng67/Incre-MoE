...
if __name__ == "__main__":
    get_annotation_eval(
        csv_file="/home/enbo/chxm/Grounding-Dino-FineTuning/dataset/flir_dataset/test_annotations.coco.csv", 
        start_index=1,
        end_index=5000, 
    ...
    checkpoint_path = "/home/enbo/chxm/Grounding-Dino-FineTuning/weights/flir_2_6.pth"
    device = "cuda"
    num_select = 300
    anno_path = "/home/enbo/chxm/Grounding-Dino-FineTuning/data_process/eval_csv/temp.json"
    image_dir = "/home/enbo/chxm/Grounding-Dino-FineTuning/dataset/flir_dataset/test"
    num_workers = 4
