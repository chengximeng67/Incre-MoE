...
category_mapping = {
    ...
    'tomato mold leaf': 6,
    'bell_pepper leaf spot': 7,
    'potato leaf early blight': 8,
    'grape leaf black rot': 9,
    ...
    'tomato leaf mosaic virus': 18,
    'tomato early blight leaf': 19,
    'soybean leaf': 20,
    'tomato leaf': 21,
    'peach leaf': 22,
    'soyabean leaf': 23,
    'corn gray leaf spot': 24,
    'apple leaf': 25,
    'strawberry leaf': 26,
    'cherry leaf': 27,
    'grape leaf': 28,
    'potato leaf': 29,
    'tomato two spotted spider mites leaf': 30
}
...
def convert_csv_to_coco(csv_file, json_file):
    coco_output = {
        ...
        "annotations": [],
        "categories": [
            {"id": 1, "name": "corn rust leaf", "supercategory": "plant"},
            {"id": 2, "name": "corn leaf blight", "supercategory": "plant"},
            {"id": 3, "name": "tomato leaf late blight", "supercategory": "plant"},
            {"id": 4, "name": "apple scab leaf", "supercategory": "plant"},
            {"id": 5, "name": "tomato septoria leaf spot", "supercategory": "plant"},
            {"id": 6, "name": "tomato mold leaf", "supercategory": "plant"},
            {"id": 7, "name": "bell_pepper leaf spot", "supercategory": "plant"},
            {"id": 8, "name": "potato leaf early blight", "supercategory": "plant"},
            {"id": 9, "name": "grape leaf black rot", "supercategory": "plant"},
            {"id": 10, "name": "tomato leaf yellow virus", "supercategory": "plant"},
            {"id": 11, "name": "blueberry leaf", "supercategory": "plant"},
            {"id": 12, "name": "bell_pepper leaf", "supercategory": "plant"},
            {"id": 13, "name": "apple rust leaf", "supercategory": "plant"},
            {"id": 14, "name": "tomato leaf bacterial spot", "supercategory": "plant"},
            {"id": 15, "name": "raspberry leaf", "supercategory": "plant"},
            {"id": 16, "name": "squash powdery mildew leaf", "supercategory": "plant"},
            {"id": 17, "name": "potato leaf late blight", "supercategory": "plant"},
            {"id": 18, "name": "tomato leaf mosaic virus", "supercategory": "plant"},
            {"id": 19, "name": "tomato early blight leaf", "supercategory": "plant"},
            {"id": 20, "name": "soybean leaf", "supercategory": "plant"},
            {"id": 21, "name": "tomato leaf", "supercategory": "plant"},
            {"id": 22, "name": "peach leaf", "supercategory": "plant"},
            {"id": 23, "name": "soyabean leaf", "supercategory": "plant"},
            {"id": 24, "name": "corn gray leaf spot", "supercategory": "plant"},
            {"id": 25, "name": "apple leaf", "supercategory": "plant"},
            {"id": 26, "name": "strawberry leaf", "supercategory": "plant"},
            {"id": 27, "name": "cherry leaf", "supercategory": "plant"},
            {"id": 28, "name": "grape leaf", "supercategory": "plant"},
            {"id": 29, "name": "potato leaf", "supercategory": "plant"},
            {"id": 30, "name": "tomato two spotted spider mites leaf", "supercategory": "plant"}
        ]
    }
...
if __name__ == "__main__":
    get_annotation_eval(
        csv_file="/home/enbo/chxm/Grounding-Dino-FineTuning/dataset/PlantD_dataset/filtered_test_annotations.csv", 
        start_index=1,
        end_index=5000, 
    ...
    checkpoint_path = "/home/enbo/chxm/Grounding-Dino-FineTuning/weights/train_plantd_4.pth"
    device = "cuda"
    num_select = 300
    anno_path = "/home/enbo/chxm/Grounding-Dino-FineTuning/data_process/eval_csv/temp.json"
    image_dir = "/home/enbo/chxm/Grounding-Dino-FineTuning/dataset/PlantD_dataset/test"
    num_workers = 4
