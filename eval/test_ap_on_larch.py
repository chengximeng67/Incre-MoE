...
def convert_csv_to_coco(csv_file, json_file):
    coco_output = {
        ...
        "annotations": [],
        "categories": [
            {"id": 1, "name": "larch", "supercategory": "tree"}
        ]
    }
...
if __name__ == "__main__":
    get_annotation_eval(
        csv_file="/home/enbo/chxm/MBMoE/dataset/larch_dataset/test.csv", 
        output_file="/home/enbo/chxm/MBMoE/dataset/larch_dataset/temp.csv",
        json_file="/home/enbo/chxm/MBMoE/dataset/larch_dataset/temp.json")
    ...
    device = "cuda"
    num_select = 300
    anno_path = "/home/enbo/chxm/MBMoE/dataset/larch_dataset/temp.json"
    image_dir = "/home/enbo/chxm/MBMoE/dataset/larch_dataset/test"
    num_workers = 4
