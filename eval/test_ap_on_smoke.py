...
def get_annotation_eval(csv_file, output_file, json_file):
...
if __name__ == "__main__":
    get_annotation_eval(
        csv_file="/home/enbo/chxm/MBMoE/dataset/smoke_dataset/test.csv",  
        output_file = "/home/enbo/chxm/MBMoE/dataset/smoke_dataset/test/temp.csv",
        json_file = "/home/enbo/chxm/MBMoE/dataset/smoke_dataset/test/temp.json")
    
    
    parser = argparse.ArgumentParser("Grounding DINO eval on COCO", add_help=True)
    
    # 直接在代码中指定路径参数
    config_file = "/home/enbo/chxm/MBMoE/groundingdino/config/GroundingDINO_SwinB_cfg.py"
    checkpoint_path = "/home/enbo/chxm/MBMoE/vector_pruning/smoke/smoke_best_weight.pth"
    device = "cuda"
    num_select = 300
    anno_path = "/home/enbo/chxm/MBMoE/dataset/smoke_dataset/test/temp.json"  # 请替换为实际的COCO注释文件路径
    image_dir = "/home/enbo/chxm/MBMoE/dataset/smoke_dataset/test"   # 请替换为实际的COCO图像目录路径
    num_workers = 4
