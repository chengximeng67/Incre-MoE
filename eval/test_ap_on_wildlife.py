...
def convert_csv_to_coco(csv_file, json_file):
    coco_output = {
        ...
        "annotations": [],
        # "categories": [
        #     {"id": 1, "name": 'buffalo', "supercategory": "animal"},
        #     {"id": 2, "name": 'elephant', "supercategory": "animal"},
        #     {"id": 3, "name": 'zebra', "supercategory": "animal"},
        #     {"id": 4, "name": 'rhino', "supercategory": "animal"}
        # ]
            "categories": [
        {"id": 1, "name": 'cow', "supercategory": "animal"}
    ]
    }
...
if __name__ == "__main__":
    convert_csv_to_coco(
        csv_file="/home/enbo/chxm/MBMoE/dataset/cow_dataset/test.csv", 
        json_file="/home/enbo/chxm/MBMoE/dataset/cow_dataset/temp.json")
    ...
    checkpoint_path = "/home/enbo/chxm/MBMoE/weights/base_weight.pth"
    device = "cuda"
    num_select = 300
    anno_path = "/home/enbo/chxm/MBMoE/dataset/cow_dataset/temp.json"
    image_dir = "/home/enbo/chxm/MBMoE/dataset/cow_dataset/test"
    num_workers = 4
