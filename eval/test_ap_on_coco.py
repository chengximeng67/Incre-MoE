...
def main(args):
    ...
    for i, (images, targets) in enumerate(data_loader):
        if i >= max_imgs:  # 添加此行，检查处理图像数量
            break  # 添加此行，达到1000张图像后跳出循环
...
if __name__ == "__main__":
    ...
    checkpoint_path = "/home/enbo/chxm/Grounding-Dino-FineTuning/weights/smoke_backbone_4.pth"
    device = "cuda"
    num_select = 300
    anno_path = "/home/enbo/chxm/dataset/annotations/instances_val2017.json"  # 请替换为实际的COCO注释文件路径
    image_dir = "/home/enbo/chxm/dataset/val2017"   # 请替换为实际的COCO图像目录路径
    num_workers = 4
