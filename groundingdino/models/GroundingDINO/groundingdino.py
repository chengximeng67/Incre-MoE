...
class GroundingDINO(nn.Module):
    ...
    def forward(self, samples: NestedTensor, targets: List = None, expert_idx_to_use: int = 0, **kw):
        """The forward expects a NestedTensor, which consists of:
           - samples.tensor: batched images, of shape [batch_size x 3 x H x W]
           - samples.mask: a binary mask of shape [batch_size x H x W], containing 1 on padded pixels

           ##### NEW/MODIFIED SIGNATURE #####
           - expert_idx_to_use (int): The index of the FFN expert to use in the encoder. Defaults to 0.
        ...
        ##### MODIFICATION POINT #####
        # Pass the 'expert_idx_to_use' parameter to the self.transformer call
        hs, reference, hs_enc, ref_enc, init_box_proposal = self.transformer(
            ...
            attn_mask, 
            text_dict,
            expert_idx_to_use=expert_idx_to_use, # Pass the routing index here
        )
